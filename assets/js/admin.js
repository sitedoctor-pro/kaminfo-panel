      ...
      datasets: [
        {
          ...
          borderColor: "#00e8ff",
          backgroundColor: "rgba(0,232,255,.13)",
          tension: 0.42,
          fill: true,
        },
        {
          label: "Visitors",
          data: rows.map((r) => r.unique_visitors),
          borderColor: "#ff2e9b",
          backgroundColor: "rgba(255,46,155,.12)",
          tension: 0.42,
          fill: true,
        },
      ],
      ...
      datasets: [
        {
          ...
          backgroundColor: "rgba(143,56,255,.72)",
          borderRadius: 12,
        },
      ],
    },
  ...
  charts.reviews = new Chart(el, {
    ...
    data: {
      ...
      datasets: [
        {
          label: "Pending",
          data: rows.map((r) => r.pending_reviews),
          backgroundColor: "rgba(255,215,106,.68)",
          borderRadius: 12,
        },
        {
          label: "Approved",
          data: rows.map((r) => r.approved_reviews),
          backgroundColor: "rgba(146,255,139,.55)",
          borderRadius: 12,
        },
      ],
    },
  ...
  document.addEventListener("click", async (e) => {
    ...
    if (deleteNotification) {
      const { error } = await sb
        .from("notification_events")
        .delete()
        .eq("id", deleteNotification.dataset.id);
